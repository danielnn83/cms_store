...
<table style="display: none;">
    <tr class="option-value-row-dummy">
        ...
        <td class="text-right">
            <input type="text" name="ProductOptionMapping[quantity][]" value="" placeholder="<?php echo UsniAdaptor::t('products', 'Cantidad');?>" class="form-control">
        </td>
        <td class="text-left">
        ...
        <td class="text-right">
            ...
            ?>
            <input type="text" name="ProductOptionMapping[price][]" value="" placeholder="<?php echo UsniAdaptor::t('products', 'Precio');?>" class="form-control"></td>
        <td class="text-right">
        ...
        ?>
            <input type="text" name="ProductOptionMapping[weight][]" value="" placeholder="<?php echo UsniAdaptor::t('products', 'Peso');?>" class="form-control"></td>
        <td class="text-right">
