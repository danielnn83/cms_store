...
use common\modules\localization\modules\orderstatus\grid\OrderStatusNameDataColumn;
...
$toolbarParams  = [
    ...
    'showBulkEdit'  => false,
    'showBulkDelete'=> true,
    'gridId'        => 'orderstatusgridview',
    'pjaxId'        => 'orderstatusgridview-pjax',
    'permissionPrefix'  => 'orderstatus'
];
$widgetParams   = [
                        'id'            => 'orderstatusgridview',
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'modelClassName' => OrderStatus::className()
                            ]
                        ],
                ];
