...
$this->title    = UsniAdaptor::t('application', 'Ver') . ' ' . UsniAdaptor::t('dataCategories', 'Categoría de datos') . ' #' . $model['id'];
...
$editUrl        = UsniAdaptor::createUrl('dataCategories/default/update', ['id' => $model['id']]);
$deleteUrl      = UsniAdaptor::createUrl('dataCategories/default/delete', ['id' => $model['id']]);
$browseParams   = ['permission' => 'datacategory.viewother',
                   'model' => $model,
