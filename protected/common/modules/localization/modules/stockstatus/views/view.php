...
$this->title    = UsniAdaptor::t('application', 'Ver') . ' ' . UsniAdaptor::t('stockstatus', 'Estado de Stock') . ' #' . $model['id'];
...
$editUrl        = UsniAdaptor::createUrl('localization/stockstatus/default/update', ['id' => $model['id']]);
$deleteUrl      = UsniAdaptor::createUrl('localization/stockstatus/default/delete', ['id' => $model['id']]);
$browseParams   = ['permission' => 'stockstatus.viewother',
                   'model' => $model,
