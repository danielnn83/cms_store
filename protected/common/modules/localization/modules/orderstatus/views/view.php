...
$this->title    = UsniAdaptor::t('application', 'Ver') . ' ' . UsniAdaptor::t('orderstatus', 'Estado del pedido') . ' #' . $model['id'];
...
$editUrl        = UsniAdaptor::createUrl('localization/orderstatus/default/update', ['id' => $model['id']]);
$deleteUrl      = UsniAdaptor::createUrl('localization/orderstatus/default/delete', ['id' => $model['id']]);
$browseParams   = ['permission' => 'orderstatus.viewother',
                   'model' => $model,
